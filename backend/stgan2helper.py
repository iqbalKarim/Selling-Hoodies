...
def generate_images(
    ...
    # pkl_path = 'file://C:/Masters/FYP/Code/backend/models/metfaces.pkl'
...
if __name__ == "__main__":
    # python
    # generate.py - -outdir = out - -trunc = 1 - -seeds = 85, 265, 297, 849 \
    G = load_pickle()
    generate_images(G, outdir='out', truncation_psi=0.7, n=6)
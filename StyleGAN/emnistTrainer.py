...
DATASET = "/vol/bitbucket/ik323/fyp/letters/"
...
def tester():
    ...
    for num_epochs in PROGRESSIVE_EPOCHS[step:]:
        ...
        save_model(generator, critic, opt_gen, opt_critic, alpha,
                   ...
                   step, identifier=f'EMNIST_step{step}_alpha{alpha}')
        generate_examples(generator, step, z_dim=Z_DIM, n=50, device=DEVICE, uniq_path="EMNIST")
        step += 1

    save_model(generator, critic, opt_gen, opt_critic, alpha,
               Z_DIM, W_DIM, IN_CHANNELS, CHANNELS_IMG,
               step, identifier='EMNIST_final')
